...
slug against our abilities, prayers, specials, specs and gear; a few are mapped by hand. Unmatched aliases
...
def main():
    ...
    for f, kind in (("abilities", "ability"), ("prayers", "prayer"), ("specials", "special"), ("specs", "spec"), ("gear", "gear")):
