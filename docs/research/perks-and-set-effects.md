...
|---|---|---|---|---|
| Igneous Kal-Ket (and Kal-Zuk) | Melee | Overpower "hits the target twice" for **280–340 %** each since 9 March 2026 (Overpower update history: "310%–370% (340% average) → 280%–340% (310% average)", base 520–570 %); the Kal-Zuk page still shows the 2 March 310–370 %. PvP 55 %. Chaos Roar applies to both hits. | 2 CD (hit count) + 3 DMG | https://runescape.wiki/w/Igneous_Kal-Zuk , https://runescape.wiki/w/Overpower |
