...
@Component({
  ...
  styles: `
    ...
    .editable .cell.empty.cdk-drop-list-receiving,
    ...
    /* valid drop target (CDK today; .can-drop / .over are hooks for a custom pointer drag) */
    ...
    .cell.cdk-drop-list-receiving::before {
      opacity: 0.9;
    }
