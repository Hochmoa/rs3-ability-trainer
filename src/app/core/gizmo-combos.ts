...
export const GIZMO_COMBOS: GizmoCombo[] = [
  ...
  w('as1pf', 'AS1PF', [['aftershock', 1], ['planted-feet', 1]], 'common', 'switch', 'Planted Feet switch (Sunspear, Ancient lantern) – standard gizmo is enough', false),
  ...
  a('eq4mobile', 'EQ4 Mobile', [['equilibrium', 4], ['mobile', 1]], 'bis', 'body', 'necromancy body gizmo 1 (Equilibrium prevents crits – never with Biting or the Dracolich set)'),
