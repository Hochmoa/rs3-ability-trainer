...
export const TOUR_STEPS: TourStep[] = [
  {
    ...
    route: '/',
    title: 'A quick tour?',
    text: 'This trainer plays a RuneScape rotation on the real clock – 0.6 second ticks, a 1.8 second global cooldown, your ping. Two minutes and you know your way around. Skip any time.',
  },
  {
    id: 'setup',
    route: '/',
    ...
    text: 'Boss, the gear for it and the rotations played with it – all in one. The PvME guides are in here as ready-made setups, and you can build your own.',
  },
  {
    id: 'rotation',
    route: '/',
    ...
    title: 'Its rotations',
    text: 'A boss is a chain of phases, so a setup holds several rotations. Pick the one you want to drill.',
  },
  {
    id: 'start',
    route: '/',
    ...
    text: 'The session runs on the game clock. Every press is scored: perfect, early, late – with the ping you set.',
  },
  {
    id: 'queue',
    route: '/',
    ...
    text: 'The big icon is due now, the small ones follow. The sweep over it is the cooldown that still has to run.',
  },
  {
    id: 'bars',
    route: '/',
    ...
    text: 'What sits here fires on your key. Anything a rotation needs but has no key yet is offered above the bars with one click.',
  },
  {
    id: 'setups-page',
    route: '/setups',
    target: '[data-tour="setup-tabs"]',
    title: 'Where the setups come from',
    text: '"All setups" holds every PvME boss setup and what other players share – one click copies gear and rotations to you. Yours live under "My setups".',
  },
  {
    id: 'gear',
    route: '/loadout',
    ...
    text: 'Sorted by how often the PvME setups use an item. Click a card for the whole group – a weapon with its off-hand, an armour set – or one icon for a single piece.',
    advancedOnly: true,
  },
  {
    id: 'bars-page',
    ...
    text: 'These are yours alone: no setup you use and nothing you import ever writes into them.',
  },
  {
    id: 'keys',
    route: '/keybinds',
    ...
    title: 'Your keys',
    text: 'A key belongs to a bar slot, exactly as in game. Bind them one by one by pressing, or take a layout and fill what is still empty.',
  },
  {
    id: 'settings',
    route: '/settings',
    target: '[data-tour="game-options"]',
    title: 'Make it your game',
    text: 'Ping, ability queueing, revolution – set them as they are for you, and the scoring matches what you feel in game.',
  },
  {
    id: 'done',
    route: '/',
    title: 'That is the whole tool',
    text: 'Pick a setup, press Start, follow the queue. The tour is in Settings whenever you want it again.',
  },
];
