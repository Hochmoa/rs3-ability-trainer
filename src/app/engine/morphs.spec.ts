...
function engine(steps: EngineEntity[], extra: EngineEntity[] = []): TrainerEngine {
  ...
  const e = new TrainerEngine(steps, catalog, { pingMs: 0, jitterMs: 0, autoAttacks: false, abilityQueueing: false, loop: false, loadout, fullAdrenaline: true, hitChanceDisabled: true });
  e.random = () => 0.99;
  return e;
}
