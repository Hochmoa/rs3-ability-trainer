...
function engine(steps: EngineEntity[], opts: { lifePoints?: number; random?: number; style?: 'Melee' | 'Necromancy' } = {}): TrainerEngine {
  ...
  const e = new TrainerEngine(steps, catalog, { pingMs: 0, jitterMs: 0, autoAttacks: false, abilityQueueing: false, loop: false, loadout, fullAdrenaline: true, hitChanceDisabled: true, targetLifePoints: opts.lifePoints });
