...
import { BUFF_BY_ID, MODELLED_WIKI_BUFFS, GLOBALS, ruleFor, scrollRuleFor, specRuleFor, spellBookOf, spellRuleFor } from './rules';
...
export class TrainerEngine {
  ...
  ruleOf(e: EngineEntity): AbilityRule | undefined {
    ...
    if (e.kind === 'special') return e.scroll ? scrollRuleFor(e.id) : undefined;
